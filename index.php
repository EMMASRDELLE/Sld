...
<head>
	...
	<link href="formhelpers/dist/css/bootstrap-formhelpers.min.css" rel="stylesheet" media="screen">
	<script src="formhelpers/js/tests/vendor/js/jquery-1.10.2.js"></script>
	<script src="assets/js/bootstrap.min.js"></script>
	<script src="formhelpers/dist/js/bootstrap-formhelpers.min.js"></script>

  	
	<title>Plateforme SLD</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Save Life Data</a>
			</div>
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="index.php">Acceuil</a></li>
					<li><a href="#cd-nav" class="cd-nav-trigger">Inscription</a></li>
			...
			<form class="navbar-form navbar-right">
				...
				<div class="bfh-selectbox bfh-countries" data-country="FR" data-flags="true">
					...
					<a class="bfh-selectbox-toggle" name="test" role="button" data-toggle="bfh-selectbox" href="index.php?lang=">
		...
		<div><input type="hidden" value="2" id="" name="test2"></div>
