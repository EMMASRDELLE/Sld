			...
			<div class="panel panel-default">
			 ...
			 <div class="panel-body">
				...
				<div class="form-group">
				 ...
				 <input type="text" name="ville" id="ville" class="form-control" style="text-transform: capitalize;" placeholder="Entrez votre ville"/>
				 <span id="error_ville" class="text-danger"></span>
				</div>

				<div class="form-group">
				 <!-- <label>Enter Pays</label> -->
				 <input type="text" name="pays" id="pays" class="form-control" style="text-transform: capitalize;" placeholder="Entrez votre pays"/>
			...
			<div class="panel panel-default">
			 ...
			 <div class="panel-body">
				...
				<div class="form-group">
				 ...
				 <input type="text" name="lieu_naissance" id="lieu_naissance" class="form-control" style="text-transform: capitalize;" style="text-transform: capitalize;"placeholder="Entrez votre lieu de naisance"/>
			...
			<div class="panel panel-default">
			 ...
			 <div class="panel-body">
				...
				<div class="form-group">
				 ...
				 <div><input type="checkbox" value="check" required="required" checked="checked" name="acceptation" id="acceptation">  J'ai lu et j'accepte les <A href="cvg/cvg.php"> conditions d'utilsation</A></div>
				</div>
				<br />
